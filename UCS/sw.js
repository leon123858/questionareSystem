 ...
 e.waitUntil(
   caches.open('video-store').then(function(cache) {
     return cache.addAll([
	   ...
	   '/questionareSystem/UCS/page3.html',
	   '/questionareSystem/UCS/page4.html',
	   '/questionareSystem/UCS/page5.html',
	   '/questionareSystem/UCS/page6.html',
	   '/questionareSystem/UCS/page7.html',
	   '/questionareSystem/UCS/page8.html',
